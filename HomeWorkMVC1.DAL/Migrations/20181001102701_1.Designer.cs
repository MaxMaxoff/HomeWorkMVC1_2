...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeWorkMVC1.Domain.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("HomeWorkMVC1.Domain.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("HomeWorkMVC1.Domain.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("HomeWorkMVC1.Domain.Entities.Order", b =>
                {
                    b.HasOne("HomeWorkMVC1.Domain.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("HomeWorkMVC1.Domain.Entities.OrderItem", b =>
                {
                    b.HasOne("HomeWorkMVC1.Domain.Entities.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId");

                    b.HasOne("HomeWorkMVC1.Domain.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HomeWorkMVC1.Domain.Entities.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
